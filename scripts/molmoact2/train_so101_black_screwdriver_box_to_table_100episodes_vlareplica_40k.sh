...
JOB_NAME="molmoact2-so101-black-screwdriver-box-to-table-100episodes-vlareplica-40k"
...
lerobot-train \
    ...
    --policy.tags='["molmoact2","so101","robocolosseum","black-screwdriver-box-to-table"]' \
