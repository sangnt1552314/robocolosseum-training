...
DATASET="Jiamo0912/so101-upright-bottle"
DATASET_ROOT="/scratch/e1583535/datasets/so101-upright-bottle"

JOB_NAME="molmoact2-so101-upright-bottle-vlareplica-40k"
...
lerobot-train \
    ...
    --policy.tags='["molmoact2","so101","robocolosseum","upright-bottle"]' \
