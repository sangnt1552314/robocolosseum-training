...
OUTPUT_DIR="outputs/molmoact2-so101-soccer-red_bowl-40episodes-6epochs"

HUB_REPO_ID="tsangb34/molmoact2-so101-soccer-red_bowl-40episodes-6epochs"

JOB_NAME="molmoact2-so101-soccer-red_bowl-40episodes-6epochs"
