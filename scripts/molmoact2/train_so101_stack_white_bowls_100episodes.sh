...
OUTPUT_DIR="outputs/molmoact2-so101-stack-white_bowls-100episodes"

HUB_REPO_ID="tsangb34/molmoact2-so101-stack-white_bowls-100episodes"

JOB_NAME="molmoact2-so101-stack-white_bowls-100episodes"
