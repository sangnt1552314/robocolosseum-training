...
OUTPUT_DIR="outputs/pi05-so101-stack-white_bowls-100episodes-mean_std-10k"

HUB_REPO_ID="tsangb34/pi05-so101-stack-white_bowls-100episodes-mean_std-10k"

JOB_NAME="pi05-so101-stack-white_bowls-100episodes-mean_std-10k"
...
lerobot-train \
    ...
    --policy.scheduler_warmup_steps=340 \
    --policy.scheduler_decay_steps=10161 \
