...
OUTPUT_DIR="outputs/pi05-so101-stack-white_bowls-100episodes-action-expert"

HUB_REPO_ID="tsangb34/pi05-so101-stack-white_bowls-100episodes-action-expert"

JOB_NAME="pi05-so101-stack-white_bowls-100episodes-action-expert"
